...
export default function AdminStudents() {
  ...
  async function refresh() {
    try {
      const [data, dashboard] = await Promise.all([api.listStudents(), api.getStudentGroupDashboard()]);
      setStudents(data);
                  ...
                  {displayedGroupDashboard.map((g) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <span className="font-semibold text-sm text-gray-900 dark:text-gray-100 block">{g.group}</span>
